...
local mappings = {
  ...
  ["P"] = {
    "<cmd>lua require('telescope').extensions.projects.projects(require('user.telescope-themes').dropdown())<cr>",
    "Projects",
  },
  ["i"] = {
  ...
  g = {
    ...
    C = { "<cmd>GitConflictListQf<cr>", "Fix conflict" },
  },
  ...
  s = {
    ...
    b = { "<cmd>Telescope git_branches<cr>", "Checkout branch" },
    c = {
      "<cmd>lua require('telescope.builtin').colorscheme(require('user.telescope-themes').dropdown())<cr>",
      "Colorscheme",
    },
