...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-calc", "cmp-cmdline", "cmp-buffer", "nvim-autopairs", "LuaSnip" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "nvim-lspconfig", "rust-tools.nvim", "nlsp-settings.nvim", "null-ls.nvim" },
    loaded = false,
    needs_bufread = true,
  ...
  ["packer.nvim"] = {
    after = { "FixCursorHold.nvim", "gruvbox8", "Colorschemes", "vscode.nvim" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "project.nvim" },
    commands = { "Telescope" },
