...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp-signature-help", "cmp-calc", "nvim-autopairs", "LuaSnip" },
  ...
  ["nvim-web-devicons"] = {
    after = { "bufferline.nvim", "which-key.nvim", "lualine.nvim" },
    load_after = {
      ["vscode.nvim"] = true
    },
    loaded = false,
  ...
  ["packer.nvim"] = {
    after = { "FixCursorHold.nvim", "gruvbox8", "vscode.nvim", "Colorschemes" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
