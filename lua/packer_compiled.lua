...
_G.packer_plugins = {
  ...
  ["git-conflict.nvim"] = {
    config = { "\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22user.git-conflict\frequire\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-cmdline", "cmp-calc", "cmp-nvim-lsp-signature-help", "LuaSnip", "cmp-buffer" },
  ...
  ["nvim-colorizer.lua"] = {
    config = { "\27LJ\2\nE\0\0\4\0\4\0\b6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0004\3\0\0B\0\3\1K\0\1\0\1\2\0\0\6*\nsetup\14colorizer\frequire\0" },
    loaded = true,
    path = "/home/notken12/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-dap-virtual-text"] = {
    config = { "\27LJ\2\n:\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\31user.nvim-dap-virtual-text\frequire\0" },
    load_after = {
      ["nvim-dap"] = true
    },
    loaded = false,
  ...
  ["nvim-lsp-installer"] = {
    after = { "null-ls.nvim", "rust-tools.nvim", "nvim-lspconfig", "nlsp-settings.nvim" },
    loaded = false,
    needs_bufread = true,
  ...
  ["nvim-web-devicons"] = {
    after = { "lualine.nvim", "bufferline.nvim", "which-key.nvim" },
    load_after = {
      ["vscode.nvim"] = true
    },
    loaded = false,
  ...
  ["packer.nvim"] = {
    after = { "gruvbox8", "FixCursorHold.nvim", "Colorschemes", "vscode.nvim" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope-dap.nvim"] = {
    config = { "\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23user.telescope-dap\frequire\0" },
    load_after = {
      ["nvim-dap"] = true
    },
    loaded = false,
  ...
  ["vim-bbye"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/notken12/.local/share/nvim/site/pack/packer/opt/vim-bbye",
